...
% params.sensor1.datafile = 'C:\Users\seba\Dropbox\Facultad\CIN\Proyectos\programasMatlab\Registros_corridas\Data.txt'; % poner la direccion de los datos
% 
% params.sensor1.label = 'T';
...
params.sensor1.tdownsample = 1;
params.sensor1.sdownsample = 20;
% index string
params.sensor1.indexstr = '1,2,3,4:2:end,5:2:end';
% maximal perception radius of sensor in [m]
params.sensor1.rs = 8.0;
% angular resolution in [rad]
params.sensor1.anglereso = 0.5*pi/180;
% constant range uncertainty in [m]
params.sensor1.stdrho = 0.02;
% robot-to-sensor transform expressed in the
% robot frame with units [m] [m] [rad]
params.sensor1.xs = [0.2945; 0; 0.0];
